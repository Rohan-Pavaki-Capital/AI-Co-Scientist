...
- If you need to include quotes inside a string, use single quotes or rephrase to avoid double quotes

Use this exact JSON shape and include all fields (use empty strings or empty arrays when needed):
