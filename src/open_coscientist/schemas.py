...
REVIEW_SCHEMA: Dict[str, Any] = {
    ...
    "schema": {
        ...
        "properties": {
            ...
            "comparative_notes": {
                "type": "string",
                "description": "Brief note on how this hypothesis compares to others",
            },
            "overall_score": {
                "type": "number",
    ...
    "schema": {
        ...
        "properties": {
            ...
            "refined_hypothesis_text": {
                "type": "string",
                "description": "Alternate key for refined hypothesis text",
            },
            "refined_hypothesis": {
                "type": "string",
                "description": "Alternate key for refined hypothesis text",
            ...
            "summary": {
                "type": "string",
                "description": "Alternate key for refinement summary",
            },
            "explanation": {
                "type": "string",
            ...
            "layman_explanation": {
                "type": "string",
                "description": "Alternate key for layman explanation",
            },
            "experiment": {
                "type": "string",
                "description": "Concrete experiment design with models, datasets, metrics, and validation criteria (4-6 sentences)",
            ...
            "experiment_design": {
                "type": "string",
                "description": "Alternate key for experiment design",
            },
            "experimental_design": {
                "type": "string",
                "description": "Alternate key for experiment design",
        ...
        "anyOf": [
            {"required": ["hypothesis"]},
            {"required": ["refined_hypothesis_text"]},
            {"required": ["refined_hypothesis"]},
...
META_REVIEW_SCHEMA: Dict[str, Any] = {
    ...
    "schema": {
        ...
        "properties": {
                ...
                "anyOf": [
                    ...
                    },
                    {
                        ...
                        "properties": {
                            ...
                            "recurring_feedback": {"type": "array", "items": {"type": "string"}},
            ...
            "top_performers_analysis": {"type": "string"},
        ...
        "anyOf": [
            {"required": ["synthesis_summary"]},
            {"required": ["meta_review_summary"]},
            {"required": ["summary"]},
            {"required": ["recurring_themes"]},
            {"required": ["common_strengths"]},
            {"required": ["strengths"]},
            {"required": ["strategic_recommendations"]},
        ],
        "additionalProperties": True,
    },
}
...
PROXIMITY_SCHEMA: Dict[str, Any] = {
    ...
    "schema": {
        ...
        "anyOf": [
            ...
            {"required": ["clusters"]},
            {"required": ["diversity_assessment"]},
            {"required": ["redundancy_assessment"]},
        ],
        "additionalProperties": True,
    },
}
