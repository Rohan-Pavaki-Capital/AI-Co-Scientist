...
"""
    ...
    refined_text = (
        ...
        or response.get("refined_hypothesis_text")
        or response.get("refined_hypothesis")
        or response.get("hypothesis_text")
        or hypothesis.text
    )
    explanation = (
        response.get("explanation")
        or response.get("layman_explanation")
        or response.get("explanation_text")
        or hypothesis.explanation
    )
    experiment = (
        response.get("experiment")
        or response.get("experiment_design")
        or response.get("experimental_design")
        or hypothesis.experiment
    )
    refinement_summary = (
        response.get("refinement_summary")
        or response.get("summary")
        or response.get("refinement_notes")
        or "no refinement summary provided"
    )
