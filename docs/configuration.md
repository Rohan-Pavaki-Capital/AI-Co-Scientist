...
generator = HypothesisGenerator(
    model_name="claude-haiku-4-5-20251001",   # Default Anthropic model
...
|-----------|---------|-------------|
| `model_name` | `"claude-haiku-4-5-20251001"` | Anthropic model in LiteLLM format (e.g., `"claude-haiku-4-5-20251001"`, `"claude-sonnet-4-6"`) |
...
Open Coscientist uses [LiteLLM](https://docs.litellm.ai/docs/providers) and is configured here for Anthropic-only model usage.
...
# Use in code
generator = HypothesisGenerator(model_name="claude-haiku-4-5-20251001")
```
...
```python
generator = HypothesisGenerator(
    model_name="claude-haiku-4-5-20251001",   # Fast, cost-efficient Anthropic model
...
```python
generator = HypothesisGenerator(
    model_name="claude-haiku-4-5-20251001",   # Cost-effective Anthropic model
